...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('through like');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'through like');

      cy.get(`[data-cy="postalCode"]`).type('among');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'among');

      cy.get(`[data-cy="city"]`).type('Hayesstad');
      cy.get(`[data-cy="city"]`).should('have.value', 'Hayesstad');

      cy.get(`[data-cy="stateProvince"]`).type('remark');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'remark');
