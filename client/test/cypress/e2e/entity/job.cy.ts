...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Investor Operations Associate');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Investor Operations Associate');

      cy.get(`[data-cy="minSalary"]`).type('11991');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '11991');

      cy.get(`[data-cy="maxSalary"]`).type('31420');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '31420');
