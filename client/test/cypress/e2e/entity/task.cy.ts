...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('hungrily ah knavishly');
      cy.get(`[data-cy="title"]`).should('have.value', 'hungrily ah knavishly');

      cy.get(`[data-cy="description"]`).type('amongst nor smart');
      cy.get(`[data-cy="description"]`).should('have.value', 'amongst nor smart');
