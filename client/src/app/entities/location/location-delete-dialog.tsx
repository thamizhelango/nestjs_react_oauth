...
export const LocationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="nestjsreactoauthApp.location.delete.question">
        <Translate contentKey="nestjsreactoauthApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
