...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="nestjsreactoauthApp.country.delete.question">
        <Translate contentKey="nestjsreactoauthApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
