...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="nestjsreactoauthApp.department.delete.question">
        <Translate contentKey="nestjsreactoauthApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
