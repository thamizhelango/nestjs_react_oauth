...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="nestjsreactoauthApp.employee.delete.question">
        <Translate contentKey="nestjsreactoauthApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
