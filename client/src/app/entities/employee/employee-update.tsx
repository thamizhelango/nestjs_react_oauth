  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nestjsreactoauthApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="nestjsreactoauthApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('nestjsreactoauthApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('nestjsreactoauthApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('nestjsreactoauthApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('nestjsreactoauthApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('nestjsreactoauthApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('nestjsreactoauthApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('nestjsreactoauthApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('nestjsreactoauthApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('nestjsreactoauthApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
