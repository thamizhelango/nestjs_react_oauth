...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="nestjsreactoauthApp.jobHistory.delete.question">
        <Translate contentKey="nestjsreactoauthApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
