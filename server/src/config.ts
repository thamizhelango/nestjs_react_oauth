...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8080';
  'jhipster.clientApp.name' = 'nestjsreactoauth';
  ...
  'jhipster.mail.from' = 'nestjsreactoauth@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'nestjsreactoauth API';
  'jhipster.swagger.description' = 'nestjsreactoauth API documentation';
  ...
  'eureka.instance.appname' = 'nestjsreactoauth';
  'eureka.instance.instanceId' = 'nestjsreactoauth:${random.value}';
  ...
  'cloud.config.name' = 'nestjsreactoauth';
